                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-start align-items-center">
                                    <h3 class="card-title">Master Category details</h3>&nbsp;
                                    <a name="add_m_category" class="btn btn-info btn-sm" href="create_m_category.php">
                                        <i class="fas fa-plus"></i>&nbsp; Add Master Category
                                    </a>
                                    <a href="sort_m_category.php" rel="modal:open" class="btn btn-primary ml-2 btn-sm" name="reg_link">
                                        <i class="fa fa-arrows"></i>&nbsp; Sort locations
                                    </a> 
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="project-actions text-left">
                                                    <a name="update" class="btn btn-info btn-sm" href="update_m_category.php?id=<?php echo $row['id']; ?>">
