                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header d-flex justify-content-start align-items-center">
                                    ...
                                    <a name="add_notices" class="btn btn-info btn-sm" href="create_notice.php">
                                        <i class="fas fa-plus"></i>&nbsp; Add Notice
                                    </a>
                                    <a href="sort_notices.php" rel="modal:open" class="btn btn-primary ml-2 btn-sm" name="reg_link">
                                        <i class="fa fa-arrows"></i>&nbsp; Sort Notices
                                    </a> 
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php include "db_connection.php" ;
                                             $query = "SELECT * FROM notice ORDER BY order_sort ASC";
                                            ...
                                            <tr>
                                                ...
                                                <td class="project-actions text-left">
                                                    <a name="update" class="btn btn-info btn-sm" href="update_notice.php?id=<?php echo $row['id']; ?>">
